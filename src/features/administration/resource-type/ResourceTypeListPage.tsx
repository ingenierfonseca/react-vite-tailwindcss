...
const RESOURCE = PermissionResource.ResourceTypes;
...
export default function ResourceTypeListPage() {
    ...
    return (
        <PageComponent
            ...
            description="Administra los tipos de recursos disponibles en la clínica"
            textButton="Agregar Tipo de Recurso"
        ...
        >
            ...
            <div className={`fixed top-0 right-0 h-full w-full md:w-7/12 bg-white dark:bg-slate-800 shadow-2xl z-50 
                ...
                {isOpenCreateOrEdit && <ResourceTypeForm setIsOpen={openCreate} itemParam={item} reload={load} />}
            </div>
        </PageComponent>
    );
}
