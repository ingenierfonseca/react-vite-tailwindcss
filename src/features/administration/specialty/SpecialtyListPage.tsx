...
const RESOURCE = PermissionResource.Specialties;
...
export default function SpecialtyListPage() {
    ...
    return (
        <PageComponent
            ...
            description="Administra las especialidades"
            textButton="Agregar Especialidad"
        ...
        >
            ...
            <div className={`fixed top-0 right-0 h-full w-full md:w-7/12 bg-white dark:bg-slate-800 shadow-2xl z-50 
                ...
                {isOpenCreateOrEdit && <SpecialtyForm setIsOpen={openCreate} itemParam={item} reload={load} />}
            </div>
        </PageComponent>
    );
}
